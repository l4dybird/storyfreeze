...
export type ResetHook = (context: StorySessionResetContext) => void | Promise<void>;
...
export type StorySessionRuntimeRegistration = {
  storyId: string;
  reset?: ResetHook;
...
export function restoreState(target: Record<string, unknown> | undefined, source: Record<string, unknown> | undefined) {
...
export function documentFingerprint(): string | undefined {
...
export function restoreScrollSnapshot(snapshot: ScrollSnapshot | undefined) {
  if (!snapshot) return;
...
export function scrollSnapshotMatches(snapshot: ScrollSnapshot | undefined) {
...
export function restoreSelectionSnapshot(snapshot: SelectionSnapshot | undefined) {
...
export function selectionSnapshotMatches(snapshot: SelectionSnapshot | undefined) {
  const selection = currentDocumentSelection();
...
export function currentActiveElement(): Element | null {
...
export function activeElementIdentity(element: Element | null = currentActiveElement()): string | null {
...
export function snapshotBaseline(runtime: StorySessionRuntimeRegistration) {
  try {
